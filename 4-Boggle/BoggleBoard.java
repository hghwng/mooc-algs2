...
public class BoggleBoard {
    ...
    /**
     * Initializes a random 4-by-4 cells, by rolling the Hasbro dice.
     */
    public BoggleBoard() {
        M = 4;
        N = 4;
    ...
    /**
     * Initializes a cells from the given filename.
     * @param filename the name of the file containing the Boggle cells
     */
    ...
    /**
     * Initializes a random M-by-N cells, according to the frequency
    ...
    /**
     * Initializes a cells from the given 2d character array,
    ...
    /**
     * Returns a string representation of the cells, replacing 'Q' with "Qu".
     * @return a string representation of the cells, replacing 'Q' with "Qu"
     */
    ...
    public static void main(String[] args) {
        ...
        // initialize a 4-by-4 cells using Hasbro dice
        StdOut.println("Hasbro cells:");
        BoggleBoard board1 = new BoggleBoard();
        StdOut.println(board1);
        StdOut.println();

        // initialize a 4-by-4 cells using letter frequencies in English language
        StdOut.println("Random 4-by-4 cells:");
        BoggleBoard board2 = new BoggleBoard(4, 4);
        StdOut.println(board2);
        StdOut.println();

        // initialize a 4-by-4 cells from a 2d char array
        StdOut.println("4-by-4 cells from 2D character array:");
        char[][] a =  {
                { 'D', 'O', 'T', 'Y' },
                { 'T', 'R', 'S', 'F' },
                { 'M', 'X', 'M', 'O' },
        ...
        // initialize a 4-by-4 cells from a file
        String filename = "cells-quinquevalencies.txt";
        StdOut.println("4-by-4 cells from file " + filename + ":");
